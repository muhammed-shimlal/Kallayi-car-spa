...
from customers.views import CustomerViewSet, SubscriptionPlanViewSet
from fleet.views import VehicleViewSet, TechnicianLocationViewSet
from bookings.views import BookingViewSet, ServicePackageViewSet, CalendarViewSet, DriverBookingViewSet
from finance.views import InvoiceViewSet, DashboardViewSet
