...
from .views import daily_settlement_ledger, settle_daily_pay, StaffDirectoryViewSet, add_staff_advance, settle_staff_payroll, staff_dashboard_stats
...
urlpatterns = [
    ...
    path('dashboard-stats/', staff_dashboard_stats, name='staff-dashboard-stats'),
